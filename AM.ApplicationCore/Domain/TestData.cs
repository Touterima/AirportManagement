...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        // Staffs
        //public static Staff captain = new Staff { Fullname=fn, EmailAddress = "captain.captain@gmail.com", BirthDate = new DateTime(1965, 01, 01), EmployementDate = new DateTime(1999, 01, 01), Salary = 99999 };
